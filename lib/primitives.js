...
function main() {
  ...
  scene.background = new THREE.Color(0x2a2c3d);
  ...
  //////   Add x, y position and an Object3D to the scene
  ...
  ////// Creates a random colored material passing geometry 
  //////  and add to scene via addObject.
